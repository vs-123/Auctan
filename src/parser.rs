...
// sha3: 1ba9ab1788cb89b6863416f4de665e4af4fe1a41c48b13ee4dede732213b34db
use std::str::FromStr;
...
mod __parse__Program {
    ...
    const __ACTION: &[i8] = &[
        // State 0
        0, 0, 0, 0, 0, 0, 0, 0, 3, 0, 15, 0, 16,
        // State 1
        0, 0, 0, 0, 0, 0, 0, 0, 3, 0, 15, 0, 16,
        // State 2
        5, 0, 0, 0, 0, 0, 0, 0, 0, 23, 0, 24, 16,
        // State 3
        5, 0, 0, 0, 0, 0, 0, 0, 0, 23, 0, 24, 16,
        // State 4
        5, 0, 0, 0, 0, 0, 0, 0, 0, 23, 0, 24, 16,
        ...
        5, 0, 0, 0, 0, 0, 0, 0, 0, 23, 0, 24, 16,
        // State 9
        0, 0, 0, 0, 0, 0, 0, 0, -18, 0, -18, 0, -18,
        // State 10
        0, 0, 0, 0, 0, 0, 0, 0, -20, 0, -20, 0, -20,
        // State 11
        0, 0, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0,
        // State 12
        0, 0, 0, 0, 0, 0, 0, 0, -19, 0, -19, 0, -19,
        // State 13
        0, 0, 0, 0, 0, 0, 0, 0, -15, 0, -15, 0, -15,
        // State 14
        0, 0, 0, 0, 0, 0, 0, 0, -2, 0, -2, 0, -2,
        // State 15
        0, -9, -9, -9, -9, -9, -9, -9, 0, 0, 0, 0, 0,
        // State 16
        0, 0, 0, 0, 0, 0, 0, 0, -16, 0, -16, 0, -16,
        // State 17
        0, 0, 0, 0, 0, 0, 26, 0, 0, 0, 0, 0, 0,
        // State 18
        0, -12, -12, -12, -12, -12, -12, 0, 0, 0, 0, 0, 0,
        // State 19
        0, -3, 6, 7, 8, 9, -3, 0, 0, 0, 0, 0, 0,
        // State 20
        0, -10, -10, -10, -10, -10, -10, 0, 0, 0, 0, 0, 0,
        // State 21
        0, -11, -11, -11, -11, -11, -11, 0, 0, 0, 0, 0, 0,
        // State 22
        0, -17, -17, -17, -17, -17, -17, 0, 0, 0, 0, 0, 0,
        // State 23
        0, -13, -13, -13, -13, -13, -13, 0, 0, 0, 0, 0, 0,
        // State 24
    ...
    {
        // Program = Program, Top => ActionFn(20);
